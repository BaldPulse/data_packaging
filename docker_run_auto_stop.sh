...
HOST_DATA_FOLDER="/NasData"  #TODO: Replace with the path to your host data folder
CONTAINER_DATA_FOLDER="/data"  # Folder inside the container
HOST_OUTPUT_FOLDER="/NasData_2/ID$ID" #TODO: Replace with the path to your host output folder
